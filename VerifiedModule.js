    ...
    const inject = () => {
        ...
        if (nameRow) {
            ...
            if (h1 && !nameRow.querySelector('.itd-v-profile')) {
                if (getVerifiedId(h1.textContent.trim())) {
                    h1.insertAdjacentHTML('afterend', getSvg('itd-v-profile'));
                }
            }
        }
